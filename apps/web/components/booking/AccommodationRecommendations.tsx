...
/**
 * Accommodation Recommendations Component
 * 
 * Displays recommended hotels/stays with affiliate links for trip templates
 */

import { Hotel, Home, Star, MapPin, ExternalLink, DollarSign } from 'lucide-react'
  ...
  return (
    <Card className={`p-4 ${className}`}>
      ...
      <p className="text-xs text-gray-600 mb-4">
        Find the perfect accommodation for your trip in {destination}
      </p>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-800">
              Book 2-3 months in advance for best rates. Consider staying slightly outside the city center for better value.
            </p>
          </div>
        </div>
      </div>
      ...
      <p className="text-xs text-gray-500 italic mt-3 leading-relaxed">
          This helps keep TravelBlogr free!
      </p>
    </Card>
  )
}
