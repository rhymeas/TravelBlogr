      ...
      <header className="bg-white sticky top-0 z-50 border-b border-gray-300 shadow-sleek-light">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:items-center lg:gap-8">
            <Link
              href="/locations"
              className="text-body-large font-medium text-sleek-black hover:text-sleek-dark-gray transition-colors py-2 px-3 rounded-lg hover:bg-gray-50"
            >
              Locations
            </Link>
            <Link
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-3">
            <Link
              href="/auth/signin"
              className="text-body-large font-medium text-sleek-black hover:text-sleek-dark-gray transition-colors py-2 px-4 rounded-lg hover:bg-gray-50"
            >
              Sign in
            </Link>
            <Link
              href="/auth/signup"
              className="btn-primary text-body-large font-semibold px-6 py-3 rounded-sleek-small hover:scale-105 transition-transform"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              <Link
                href="/auth/signup"
                className="btn-primary px-8 py-4 text-body-large font-semibold rounded-sleek-small w-full sm:w-auto hover:scale-105 transition-transform inline-flex items-center justify-center gap-2"
              >
                Start Your Journey
      ...
      <section id="features" className="py-20 sm:py-32 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="card-elevated p-8 hover:shadow-sleek-large transition-all duration-300 group">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-title-medium text-sleek-black font-semibold">
                TravelBlogr
              </span>
            </div>
